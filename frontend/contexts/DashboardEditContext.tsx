...
const DEFAULT_LAYOUT: DashboardLayout = {
  cards: [
    ...
    { id: "prediction-history", title: "Tahmin Geçmişi & Sonuçlar", column: "center", order: 20.5, visible: true, size: "full", collapsed: false },
...
const LAYOUT_STORAGE_KEY = "dashboard-layout-v5";
