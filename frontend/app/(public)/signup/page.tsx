      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white/[0.05] backdrop-blur-lg border border-white/[0.10] rounded-2xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-[#E5E7EB]/60">Join ForexsAi and start trading smarter</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            {/* Full Name */}
            <div>
              <label htmlFor="fullName" className="block text-sm font-medium text-[#E5E7EB]/80 mb-2">
                Full Name
              </label>
              <input
                id="fullName"
          ...
          <div className="mt-8 text-center">
            <p className="text-[#E5E7EB]/60">
              ...
              <Link href="/login" className="text-[#00E0C6] hover:text-[#00E0C6]/80 transition-colors font-medium">
                Sign in
              </Link>
            </p>
          </div>
