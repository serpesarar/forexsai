      ...
      {data && (
        <>
          ...
          <div className={`p-6 bg-gradient-to-b ${getTrendBg(data.trend.direction)}`}>
            <div className="text-center">
              ...
              <div className="flex items-center justify-center gap-1 mt-4">
                <span className="text-xs text-gray-500 mr-2">Son 5 dk:</span>
          ...
          <div className="flex items-center justify-center gap-8 p-3 bg-gray-800/50 border-b border-gray-800">
            <div className="text-center">
              <span className="text-gray-500 text-xs">💰 FİYAT</span>
              <p className="text-xl font-bold text-white">{data.price.current.toFixed(2)}</p>
            </div>
            <div className="text-center">
              <span className="text-gray-500 text-xs">📈 Değişim (5dk)</span>
            ...
            <div className="text-center">
              <span className="text-gray-500 text-xs">⏱️ Güncelleme</span>
              <p className="text-sm text-gray-300">Her 5 sn</p>
            </div>
          </div>
            ...
            <div className="bg-gray-800 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between bg-blue-900/30 -mx-2 px-2 py-1 rounded">
                  <span className="text-blue-400">Fiyat:</span>
              ...
              {data.levels.s1.alert && (
                <p className="text-xs text-yellow-400 mt-2">
                  ⭐ Destek bölgesine yakın ({data.levels.s1.distance.toFixed(0)} pts)
                </p>
              )}
            </div>
            ...
            <div className="bg-gray-800 rounded-lg p-4">
              ...
              <div className="text-center py-4">
                ...
                <p className="text-xs text-gray-500 mt-2">
                  {data.volume.status === "high" ? "Alıcılar aktif" :
                   data.volume.status === "low" ? "Düşük ilgi" : "Veri yok"}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="p-4">
            <div className="bg-gradient-to-r from-blue-900/30 to-purple-900/30 rounded-lg p-4 border border-blue-800">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="font-medium text-white">💡 ANLIK YORUM (AI)</span>
              </div>
              ...
              <div className="grid grid-cols-4 gap-4 text-center">
                ...
                <div>
                  <p className="text-xs text-gray-500">⏱️ Beklenti</p>
