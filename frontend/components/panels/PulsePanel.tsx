...
export default function PulsePanel({ symbol: initialSymbol = "NDX.INDX", onSwitchMode }: PulsePanelProps) {
  ...
  return (
    <div className="bg-gray-900 rounded-xl border border-gray-800 overflow-hidden">
      {/* Header */}
      <div className="bg-gradient-to-r from-yellow-900/50 to-orange-900/50 p-3 border-b border-gray-800">
        <div className="flex items-center justify-between flex-wrap gap-2">
          <div className="flex items-center gap-2 min-w-0">
            <div className="w-8 h-8 bg-yellow-600 rounded-lg flex items-center justify-center animate-pulse flex-shrink-0">
              <Zap className="w-5 h-5 text-white" />
            </div>
            <div className="min-w-0">
              <h2 className="text-sm font-bold text-white truncate">{t("pulse.title")}</h2>
              <p className="text-xs text-gray-400 truncate">{t("pulse.subtitle")}</p>
            </div>
          </div>
          <div className="flex items-center gap-1.5 flex-wrap">
            ...
            {onSwitchMode && (
              <button
                ...
                className="flex items-center gap-1 bg-blue-600 hover:bg-blue-700 text-white px-2 py-1 rounded-lg text-xs"
              >
      ...
      {data && (
        <>
          ...
          {/* Price & Time Bar */}
          <div className="flex items-center justify-center gap-4 sm:gap-8 p-3 bg-gray-800/50 border-b border-gray-800 flex-wrap">
            <div className="text-center">
          ...
          <div className="p-3 pt-0 flex gap-2 flex-wrap">
            <button className="flex-1 min-w-[100px] bg-green-600 hover:bg-green-700 text-white py-2 rounded-lg font-medium flex items-center justify-center gap-1 text-sm">
              <TrendingUp className="w-4 h-4" />
              {t("pulse.watchUp")}
            </button>
            <button className="flex-1 min-w-[100px] bg-red-600 hover:bg-red-700 text-white py-2 rounded-lg font-medium flex items-center justify-center gap-1 text-sm">
              <TrendingDown className="w-4 h-4" />
              {t("pulse.watchDown")}
            </button>
            <button className="flex-1 min-w-[100px] bg-gray-700 hover:bg-gray-600 text-white py-2 rounded-lg font-medium flex items-center justify-center gap-1 text-sm">
